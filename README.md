...
Source data are provided with the journal *Nature Communications*.

Each notebook includes a `sessionInfo()` section at end documenting R environment used.

Knitted HTML (.html) files are also included for easy viewing. To view, download file and open in web browser.
